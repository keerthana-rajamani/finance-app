        ...
        <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl border border-white/60 shadow-lg space-y-4">
          ...
          <form onSubmit={handleFormSubmit} className="flex gap-2 pt-2">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-[#DB5375] hover:bg-[#c53e61] text-white rounded-xl text-xs font-semibold shadow-md shadow-[#DB5375]/25 transition-all flex items-center gap-1.5 disabled:opacity-50"
            >
