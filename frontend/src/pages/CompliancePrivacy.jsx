...
export default function CompliancePrivacy() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 fade-in">
      ...
      <div className="flex items-center gap-2 mb-6 text-xs text-slate-700 font-semibold">
        <Link to="/" className="hover:text-[#DB5375] flex items-center gap-1">
          <ArrowLeft className="w-3.5 h-3.5" /> Back to Home
        </Link>
        <span>/</span>
        <span className="text-slate-900 font-extrabold">Compliance & Privacy Center</span>
      </div>
      ...
      <div className="theme-card p-8 mb-8 relative overflow-hidden floating-card">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 border border-rose-100 text-[#DB5375] text-xs font-extrabold mb-3">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer ${
                activeTab === tab.id
                  ? 'bg-[#DB5375] text-white shadow-md -translate-y-0.5'
                  : 'bg-white text-slate-700 border border-slate-200 hover:bg-rose-50 hover:text-[#DB5375]'
              }`}
            >
              {tab.label}
            </button>
      ...
      {(activeTab === 'all') && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <div className="theme-card p-6 floating-card">
            <div className="w-10 h-10 rounded-xl bg-rose-50 border border-rose-100 text-[#DB5375] flex items-center justify-center mb-3">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h3 className="font-extrabold text-sm text-slate-900 mb-1">RBI Account Aggregator</h3>
          ...
          <div className="theme-card p-6 floating-card">
            ...
            <h3 className="font-extrabold text-sm text-slate-900 mb-1">Bank-Grade Encryption</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="theme-card p-6 floating-card">
            ...
            <h3 className="font-extrabold text-sm text-slate-900 mb-1">DPDP Act 2023 Rights</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="theme-card p-6 floating-card">
            ...
            <h3 className="font-extrabold text-sm text-slate-900 mb-1">Immutable Audit Logs</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
        ...
        {(activeTab === 'all' || activeTab === 'privacy') && (
          <section className="theme-card p-8 floating-card space-y-6">
            <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
              <div className="w-10 h-10 rounded-xl bg-rose-50 border border-rose-100 text-[#DB5375] flex items-center justify-center">
                <FileText className="w-5 h-5" />
              </div>
              <div>
                <h2 className="text-xl font-extrabold text-slate-900">1. Data Privacy Policy & DPDP Act 2023</h2>
                <p className="text-xs text-slate-500 font-medium">Last updated: September 2026 • Governing Law: Digital Personal Data Protection Act, 2023</p>
              </div>
            </div>

            <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-1">1.1 Information We Collect</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-1">1.2 Purpose Limitation & Non-Disclosure</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-1">1.3 User Privacy Rights under DPDP Act</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2">
                  <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                    <h4 className="font-bold text-slate-900 mb-1">Right to Access & Export</h4>
                    <p className="text-[11px] text-slate-600">Export your consolidated transaction ledgers, investment portfolios, and tax records in JSON/CSV formats at any time.</p>
                  </div>
                  <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                    <h4 className="font-bold text-slate-900 mb-1">Right to Erasure</h4>
                    <p className="text-[11px] text-slate-600">Request permanent deletion of all stored financial data and Account Aggregator tokens with immediate server purge.</p>
                  </div>
                  <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                    <h4 className="font-bold text-slate-900 mb-1">Consent Revocation</h4>
                    <p className="text-[11px] text-slate-600">Revoke linked bank synchronization with a single click. No residual background queries will be dispatched.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {(activeTab === 'all' || activeTab === 'rbi-aa') && (
          <section className="theme-card p-8 floating-card space-y-6">
            <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-slate-900">2. RBI Account Aggregator (AA) Consent Standards</h2>
                <p className="text-xs text-slate-500 font-medium">Compliance with Reserve Bank of India Master Direction - Non-Banking Financial Company - Account Aggregator (Directions), 2016</p>
              </div>
            </div>
            ...
            <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                  <h4 className="font-bold text-slate-900 text-sm flex items-center gap-1.5">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Read-Only Data Architecture
                  </h4>
                ...
                <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                  <h4 className="font-bold text-slate-900 text-sm flex items-center gap-1.5">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Granular Consent Parameters
                  </h4>
                  <p className="text-slate-600 text-[11px]">
              ...
              <div className="p-3.5 bg-rose-50 border border-rose-100 rounded-xl flex items-center gap-3">
                <AlertTriangle className="w-5 h-5 text-[#DB5375] flex-shrink-0" />
        ...
        {(activeTab === 'all' || activeTab === 'terms') && (
          <section className="theme-card p-8 floating-card space-y-6">
            <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-slate-900">3. Terms of Service & Disclaimer</h2>
                <p className="text-xs text-slate-500 font-medium">User Agreement, Responsibilities & Advisory Limitations</p>
              </div>
            </div>

            <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-1">3.1 Role-Based Access Governance</h3>
                <p>
                ...
                <ul className="list-disc pl-5 mt-1 space-y-1 text-slate-600">
                  ...
                  <li><strong>Support Agents:</strong> Operational diagnostics with fully masked account identifiers (<code className="bg-slate-100 px-1 py-0.5 rounded font-mono">••••4521</code>) and zero visibility into personal transaction descriptions.</li>
                </ul>
              </div>

              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-1">3.2 AI Financial Advisory Disclaimer</h3>
        ...
        {(activeTab === 'all' || activeTab === 'security') && (
          <section className="theme-card p-8 floating-card space-y-6">
            <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-slate-900">4. Bank-Grade Security & Audit Logging</h2>
                <p className="text-xs text-slate-500 font-medium">Cryptographic Specifications, Encryption at Rest & Audit Trails</p>
              </div>
            </div>
            ...
            <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl">
                  <span className="font-mono text-xs font-bold text-[#DB5375] block mb-1">AES-256 GCM</span>
                  <h4 className="font-bold text-slate-900 mb-1">Encryption at Rest</h4>
                  <p className="text-[11px] text-slate-600">All database records, transaction amounts, and customer credentials are encrypted with Galois/Counter Mode authentication.</p>
                </div>

                <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl">
                  <span className="font-mono text-xs font-bold text-[#DB5375] block mb-1">TLS 1.3 Strict</span>
                  <h4 className="font-bold text-slate-900 mb-1">Encryption in Transit</h4>
                  <p className="text-[11px] text-slate-600">Zero cleartext data over wire. Perfect forward secrecy enabled on all API endpoints and WebSocket channels.</p>
                </div>

                <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl">
                  <span className="font-mono text-xs font-bold text-[#DB5375] block mb-1">SHA-256 Hash</span>
                  <h4 className="font-bold text-slate-900 mb-1">One-Way PII Protection</h4>
                  <p className="text-[11px] text-slate-600">PAN credentials and authentication tokens are irreversible one-way hashed with cryptographically salted digests.</p>
                </div>
              </div>

              <div>
                <h3 className="font-bold text-sm text-slate-900 mb-1">4.1 Immutable Security Audit Trail</h3>
                <p className="text-slate-600">
      ...
      <div className="theme-card p-6 mt-10 floating-card">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h3 className="font-extrabold text-sm text-slate-900">Data Protection Officer & Grievance Redressal</h3>
            ...
            <div className="mt-2 flex flex-wrap gap-4 text-xs font-mono">
              <span className="text-slate-700"><strong>Officer:</strong> Grievance Redressal Officer</span>
              <span className="text-[#DB5375] font-bold">dpo@personalfinance.app</span>
              <span className="text-slate-500">Response turnaround: within 48 business hours</span>
            </div>
          </div>
          <Link
            to="/dashboard"
